...
class PurchaseOrder(models.Model):
    ...
    received_state_progress = fields.Float(string='Received Progress', default=0.0, store=True, digits=(16, 1))
    received_count = fields.Integer(string='Received count', compute="_compute_total_order_count")
    total_count = fields.Integer(string='Total count', compute="_compute_total_order_count")

    purchase_origin_id = fields.Many2one('purchase.order', string='Purchase Origin ID')
